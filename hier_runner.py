...
def learn(env, policy_fn, *, num_options=2,
          ...
          optim_epochs, mainlr, optim_batchsize=160,  # optimization hypers
    ...
    pi.init_hybridmodel(svm_grid_params, svm_params_interest, svm_params_guard)
    ...
    while True:
        ...
        p.append(data)
        pickle.dump(p, open("option_critic_data.pkl", "wb"))
        if nmodes == num_options:  # slight hack here, currently only testing with 2 modes, improve to nmodes
            ...
            pi.learn_hybridmodel(x_train_dataset, label_train_dataset, xu_train_dataset, label_t_train_dataset)
