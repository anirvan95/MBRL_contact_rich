...
stime = time.time()
f = open("results/MOAC/isexp2_11/data/rollout_data.pkl", "rb")
p = pickle.load(f)
f.close()
...
for iter in range(0, len(p), 3):
    ...
    for rollout in range(0, rollouts):
        ...
        for t in range(0, len(time_vect)):
            ...
            ax.plot(t, value[t, selected_options[0]], '.r-', label='op_0', linewidth=0.3)
            ax.plot(t, value[t, selected_options[1]], '.b-', label='op_1', linewidth=0.5)
            ax.plot(t, value[t, selected_options[2]], '.g-', label='op_2', linewidth=0.6, alpha=0.2)
            ax.plot(t, value[t, selected_options[3]], '.c-', label='op_3', linewidth=0.7, alpha=0.4)
            ax.plot(t, value[t, selected_options[4]], '.m-', label='op_3', linewidth=0.8, alpha=0.4)
            ...
            ax.plot(t, interest[t, selected_options[0]], '.r-', label='op_0', linewidth=0.3)
            ax.plot(t, termination[t, selected_options[0]], '.k-', label='op_0', linewidth=0.5, alpha=0.2)

            ax = fig.add_subplot(3, 4, 9)
            ax.plot(t, interest[t, selected_options[1]], '.b-', label='op_1', linewidth=0.3)
            ax.plot(t, termination[t, selected_options[1]], '.k-', label='op_1', linewidth=0.5, alpha=0.2)

            ax = fig.add_subplot(3, 4, 10)
            ax.plot(t, interest[t, selected_options[2]], '.g-', label='op_2', linewidth=0.3)
            ax.plot(t, termination[t, selected_options[2]], '.k-', label='op_2', linewidth=0.5, alpha=0.2)

            ax = fig.add_subplot(3, 4, 11)
            ax.plot(t, interest[t, selected_options[3]], '.c-', label='op_3', linewidth=0.3)
            ax.plot(t, termination[t, selected_options[3]], '.k-', label='op_3', linewidth=0.5, alpha=0.2)

            ax = fig.add_subplot(3, 4, 12)
            ax.plot(t, interest[t, selected_options[4]], '.m-', label='op_0', linewidth=0.5)
            ax.plot(t, termination[t, selected_options[4]], '.k-', label='op_0', linewidth=0.5, alpha=0.2)


    file_name = 'figures/MOAC/isexp2_11/iteration_' + str(iter)
    plt.savefig(file_name)
    plt.close()


model = pickle.load(open('results/MOAC/isexp2_11/model/hybrid_model.pkl','rb'))
...
plt.savefig('figures/MOAC/isexp2_11/transition_graph.png')
