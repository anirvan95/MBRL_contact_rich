...
def train(env_id, num_iteration, seed, model_path=None):
    ...
    def policy_fn(name, ob_space, ac_space):
        return ioc_model.MlpPolicy(name=name, ob_space=ob_space, ac_space=ac_space, hid_size=64, num_hid_layers=2, num_options=2, dc=0, w_intfc=True, k=0)
    ...
    pi = ioc_runner.learn(env, model_path, policy_fn, num_options=2,
                          ...
                          optim_epochs=50, optim_stepsize=2.75e-4, optim_batchsize=32,  # optimization hypers
